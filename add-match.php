...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>Ash Gold - Add Match</title>
    ...
    <div class="col-md-10 col-12">
      <div class="card">
        <div class="card-header">
          <center><h4 class="card-title">ADD MATCH  </h4></center>
        </div>
        <div class="card-content">
          <div class="card-body">
            <form class="form form-horizontal" id="mtfrm">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-4">
                    <label>Title</label>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="title" placeholder="eg:  Team A Vs Team B">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="venue" placeholder="Venue">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="date" id="first-name" class="form-control" name="date" placeholder="Date">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="time" id="first-name" class="form-control" name="time" placeholder="Time">
                  </div>
