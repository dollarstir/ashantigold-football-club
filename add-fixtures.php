...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>Ash Gold - Add Fixtures</title>
    ...
    <div class="col-md-10 col-12">
      <div class="card">
        <div class="card-header">
          <center><h4 class="card-title">ADD FIXTURES  </h4></center>
        </div>
        <div class="card-content">
          <div class="card-body">
            <form class="form form-horizontal" id="fixfrm">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="team1" placeholder="Team 1">
                  </div>


                  <div class="col-md-4">
                    <label>Image of  Team 1</label>
                  </div>
                  <div class="col-md-8 form-group">
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="team1goal" placeholder="Team 1 goals">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="team2" placeholder="Team 2">
                  </div>


                  <div class="col-md-4">
                    <label>Image of  Team 2</label>
                  </div>
                  <div class="col-md-8 form-group">
                  <div class="custom-file">
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="team2goal" placeholder="Team 2 goals">
                  </div>
