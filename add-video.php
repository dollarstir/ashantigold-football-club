...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>Ash Gold - Add Video</title>
    ...
    <div class="col-md-10 col-12">
      <div class="card">
        <div class="card-header">
          <center><h4 class="card-title">ADD VIDEO  </h4></center>
        </div>
        <div class="card-content">
          <div class="card-body">
            <form class="form form-horizontal" id="videofrm">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-4">
                    <label>Title</label>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="link" placeholder="video link">
                  </div>
